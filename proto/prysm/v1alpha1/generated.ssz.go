...
// Hash: 96111e89bd8a584914b392a72c17b550d8db22bb5dfe7517af431cbfbfea6d6f
package eth
...
// MarshalSSZ ssz marshals the KzgCommitmentInclusionProof object
func (k *KzgCommitmentInclusionProof) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(k)
}

// MarshalSSZTo ssz marshals the KzgCommitmentInclusionProof object to a target array
func (k *KzgCommitmentInclusionProof) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf

	// Field (0) 'CommitmentInclusionProof'
	if size := len(k.CommitmentInclusionProof); size != 17 {
		err = ssz.ErrVectorLengthFn("--.CommitmentInclusionProof", size, 17)
		return
	}
	for ii := 0; ii < 17; ii++ {
		if size := len(k.CommitmentInclusionProof[ii]); size != 32 {
			err = ssz.ErrBytesLengthFn("--.CommitmentInclusionProof[ii]", size, 32)
			return
		}
		dst = append(dst, k.CommitmentInclusionProof[ii]...)
	}

	return
}

// UnmarshalSSZ ssz unmarshals the KzgCommitmentInclusionProof object
func (k *KzgCommitmentInclusionProof) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 544 {
		return ssz.ErrSize
	...
	// Field (0) 'CommitmentInclusionProof'
	k.CommitmentInclusionProof = make([][]byte, 17)
	for ii := 0; ii < 17; ii++ {
		if cap(k.CommitmentInclusionProof[ii]) == 0 {
			k.CommitmentInclusionProof[ii] = make([]byte, 0, len(buf[0:544][ii*32:(ii+1)*32]))
		}
		k.CommitmentInclusionProof[ii] = append(k.CommitmentInclusionProof[ii], buf[0:544][ii*32:(ii+1)*32]...)
	}

	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the KzgCommitmentInclusionProof object
func (k *KzgCommitmentInclusionProof) SizeSSZ() (size int) {
	size = 544
	return
}

// HashTreeRoot ssz hashes the KzgCommitmentInclusionProof object
func (k *KzgCommitmentInclusionProof) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(k)
}

// HashTreeRootWith ssz hashes the KzgCommitmentInclusionProof object with a hasher
func (k *KzgCommitmentInclusionProof) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	// Field (0) 'CommitmentInclusionProof'
	{
		...
		subIndx := hh.Index()
		for _, i := range k.CommitmentInclusionProof {
			if len(i) != 32 {
				err = ssz.ErrBytesLength
				return
			}
...
// MarshalSSZ ssz marshals the ColumnSidecar object
func (c *ColumnSidecar) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(c)
}

// MarshalSSZTo ssz marshals the ColumnSidecar object to a target array
func (c *ColumnSidecar) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(264)
	...
	// Offset (1) 'Segments'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(c.Segments); ii++ {
		offset += 4
		offset += len(c.Segments[ii])
	}

	// Offset (2) 'BlobKzgCommitments'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(c.BlobKzgCommitments); ii++ {
		offset += 4
		offset += len(c.BlobKzgCommitments[ii])
	}

	// Offset (3) 'SegmentKzgProofs'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(c.SegmentKzgProofs); ii++ {
		offset += 4
		offset += len(c.SegmentKzgProofs[ii])
	}
	...
	// Offset (5) 'CommitmentInclusionProofs'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(c.CommitmentInclusionProofs) * 544

	// Field (6) 'CommitmentsHash'
	if size := len(c.CommitmentsHash); size != 32 {
		err = ssz.ErrBytesLengthFn("--.CommitmentsHash", size, 32)
		return
	}
	...
	for ii := 0; ii < len(c.Segments); ii++ {
		if size := len(c.Segments[ii]); size > 2048 {
			err = ssz.ErrBytesLengthFn("--.Segments[ii]", size, 2048)
			return
		}
		dst = append(dst, c.Segments[ii]...)
	}
	...
	{
		offset = 4 * len(c.BlobKzgCommitments)
		for ii := 0; ii < len(c.BlobKzgCommitments); ii++ {
			dst = ssz.WriteOffset(dst, offset)
			offset += len(c.BlobKzgCommitments[ii])
		}
	...
	for ii := 0; ii < len(c.BlobKzgCommitments); ii++ {
		if size := len(c.BlobKzgCommitments[ii]); size > 48 {
			err = ssz.ErrBytesLengthFn("--.BlobKzgCommitments[ii]", size, 48)
			return
		}
		dst = append(dst, c.BlobKzgCommitments[ii]...)
	}
	...
	{
		offset = 4 * len(c.SegmentKzgProofs)
		for ii := 0; ii < len(c.SegmentKzgProofs); ii++ {
			dst = ssz.WriteOffset(dst, offset)
			offset += len(c.SegmentKzgProofs[ii])
		}
	...
	for ii := 0; ii < len(c.SegmentKzgProofs); ii++ {
		...
		dst = append(dst, c.SegmentKzgProofs[ii]...)
	}
	...
	for ii := 0; ii < len(c.CommitmentInclusionProofs); ii++ {
		if dst, err = c.CommitmentInclusionProofs[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}
...
// UnmarshalSSZ ssz unmarshals the ColumnSidecar object
func (c *ColumnSidecar) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 264 {
		return ssz.ErrSize
	...
	// Field (0) 'Index'
	c.Index = ssz.UnmarshallUint64(buf[0:8])
	...
	if err = c.SignedBlockHeader.UnmarshalSSZ(buf[20:228]); err != nil {
		return err
	}

	// Offset (5) 'CommitmentInclusionProofs'
	if o5 = ssz.ReadOffset(buf[228:232]); o5 > size || o3 > o5 {
		return ssz.ErrOffset
	}

	// Field (6) 'CommitmentsHash'
	if cap(c.CommitmentsHash) == 0 {
		c.CommitmentsHash = make([]byte, 0, len(buf[232:264]))
	}
	c.CommitmentsHash = append(c.CommitmentsHash, buf[232:264]...)
	...
	// Field (1) 'Segments'
	{
		...
		c.Segments = make([][]byte, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if len(buf) > 2048 {
				return ssz.ErrBytesLength
			}
			if cap(c.Segments[indx]) == 0 {
				c.Segments[indx] = make([]byte, 0, len(buf))
			}
			c.Segments[indx] = append(c.Segments[indx], buf...)
			return nil
		})
		if err != nil {
			return err
	...
	// Field (2) 'BlobKzgCommitments'
	{
		...
		c.BlobKzgCommitments = make([][]byte, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if len(buf) > 48 {
				return ssz.ErrBytesLength
			}
			if cap(c.BlobKzgCommitments[indx]) == 0 {
				c.BlobKzgCommitments[indx] = make([]byte, 0, len(buf))
			}
			c.BlobKzgCommitments[indx] = append(c.BlobKzgCommitments[indx], buf...)
			return nil
		})
		if err != nil {
			return err
	...
	// Field (3) 'SegmentKzgProofs'
	{
		...
		c.SegmentKzgProofs = make([][]byte, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if len(buf) > 48 {
				return ssz.ErrBytesLength
			}
			if cap(c.SegmentKzgProofs[indx]) == 0 {
				c.SegmentKzgProofs[indx] = make([]byte, 0, len(buf))
			}
			c.SegmentKzgProofs[indx] = append(c.SegmentKzgProofs[indx], buf...)
			return nil
		})
		if err != nil {
			return err
	...
	// Field (5) 'CommitmentInclusionProofs'
	{
		...
		c.CommitmentInclusionProofs = make([]*KzgCommitmentInclusionProof, num)
		for ii := 0; ii < num; ii++ {
			if c.CommitmentInclusionProofs[ii] == nil {
				c.CommitmentInclusionProofs[ii] = new(KzgCommitmentInclusionProof)
			}
			if err = c.CommitmentInclusionProofs[ii].UnmarshalSSZ(buf[ii*544 : (ii+1)*544]); err != nil {
				return err
			}
		}
	}
...
// SizeSSZ returns the ssz encoded size in bytes for the ColumnSidecar object
func (c *ColumnSidecar) SizeSSZ() (size int) {
	size = 264

	// Field (1) 'Segments'
	for ii := 0; ii < len(c.Segments); ii++ {
		size += 4
		size += len(c.Segments[ii])
	}

	// Field (2) 'BlobKzgCommitments'
	for ii := 0; ii < len(c.BlobKzgCommitments); ii++ {
		size += 4
		size += len(c.BlobKzgCommitments[ii])
	}

	// Field (3) 'SegmentKzgProofs'
	for ii := 0; ii < len(c.SegmentKzgProofs); ii++ {
		size += 4
		size += len(c.SegmentKzgProofs[ii])
	}

	// Field (5) 'CommitmentInclusionProofs'
	size += len(c.CommitmentInclusionProofs) * 544

	return
}

// HashTreeRoot ssz hashes the ColumnSidecar object
func (c *ColumnSidecar) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(c)
}

// HashTreeRootWith ssz hashes the ColumnSidecar object with a hasher
func (c *ColumnSidecar) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	// Field (2) 'BlobKzgCommitments'
	{
		...
		for _, elem := range c.BlobKzgCommitments {
			{
				elemIndx := hh.Index()
				byteLen := uint64(len(elem))
				if byteLen > 48 {
	...
	// Field (3) 'SegmentKzgProofs'
	{
		...
		for _, elem := range c.SegmentKzgProofs {
			{
				elemIndx := hh.Index()
				byteLen := uint64(len(elem))
				if byteLen > 48 {
	...
	// Field (5) 'CommitmentInclusionProofs'
	{
		...
		for _, elem := range c.CommitmentInclusionProofs {
			if err = elem.HashTreeRootWith(hh); err != nil {
				return
			}
		}
...
// MarshalSSZ ssz marshals the ColumnSidecars object
func (c *ColumnSidecars) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(c)
}

// MarshalSSZTo ssz marshals the ColumnSidecars object to a target array
func (c *ColumnSidecars) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(4)

	// Offset (0) 'ColumnSidecars'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(c.ColumnSidecars); ii++ {
		offset += 4
		offset += c.ColumnSidecars[ii].SizeSSZ()
	}

	// Field (0) 'ColumnSidecars'
	if size := len(c.ColumnSidecars); size > 128 {
		err = ssz.ErrListTooBigFn("--.ColumnSidecars", size, 128)
		return
	}
	{
		offset = 4 * len(c.ColumnSidecars)
		for ii := 0; ii < len(c.ColumnSidecars); ii++ {
			dst = ssz.WriteOffset(dst, offset)
			offset += c.ColumnSidecars[ii].SizeSSZ()
		}
	...
	for ii := 0; ii < len(c.ColumnSidecars); ii++ {
		if dst, err = c.ColumnSidecars[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}
...
// UnmarshalSSZ ssz unmarshals the ColumnSidecars object
func (c *ColumnSidecars) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 4 {
		return ssz.ErrSize
	...
	// Field (0) 'ColumnSidecars'
	{
		...
		c.ColumnSidecars = make([]*ColumnSidecar, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if c.ColumnSidecars[indx] == nil {
				c.ColumnSidecars[indx] = new(ColumnSidecar)
			}
			if err = c.ColumnSidecars[indx].UnmarshalSSZ(buf); err != nil {
				return err
			}
			return nil
		})
...
// SizeSSZ returns the ssz encoded size in bytes for the ColumnSidecars object
func (c *ColumnSidecars) SizeSSZ() (size int) {
	size = 4

	// Field (0) 'ColumnSidecars'
	for ii := 0; ii < len(c.ColumnSidecars); ii++ {
		size += 4
		size += c.ColumnSidecars[ii].SizeSSZ()
	}

	return
}

// HashTreeRoot ssz hashes the ColumnSidecars object
func (c *ColumnSidecars) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(c)
}

// HashTreeRootWith ssz hashes the ColumnSidecars object with a hasher
func (c *ColumnSidecars) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()

	// Field (0) 'ColumnSidecars'
	{
		subIndx := hh.Index()
		num := uint64(len(c.ColumnSidecars))
		if num > 128 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for _, elem := range c.ColumnSidecars {
			if err = elem.HashTreeRootWith(hh); err != nil {
				return
			}
		}
...
// MarshalSSZ ssz marshals the ColumnIdentifier object
func (c *ColumnIdentifier) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(c)
}

// MarshalSSZTo ssz marshals the ColumnIdentifier object to a target array
func (c *ColumnIdentifier) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf

	// Field (0) 'BlockRoot'
	if size := len(c.BlockRoot); size != 32 {
		err = ssz.ErrBytesLengthFn("--.BlockRoot", size, 32)
		return
	}
...
// UnmarshalSSZ ssz unmarshals the ColumnIdentifier object
func (c *ColumnIdentifier) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 40 {
		return ssz.ErrSize
	...
	// Field (0) 'BlockRoot'
	if cap(c.BlockRoot) == 0 {
		c.BlockRoot = make([]byte, 0, len(buf[0:32]))
	}
	c.BlockRoot = append(c.BlockRoot, buf[0:32]...)

	// Field (1) 'Index'
	c.Index = ssz.UnmarshallUint64(buf[32:40])

	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the ColumnIdentifier object
func (c *ColumnIdentifier) SizeSSZ() (size int) {
	size = 40
	return
}

// HashTreeRoot ssz hashes the ColumnIdentifier object
func (c *ColumnIdentifier) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(c)
}

// HashTreeRootWith ssz hashes the ColumnIdentifier object with a hasher
func (c *ColumnIdentifier) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
func (m *MetaDataV2) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'Colnets'
	if size := len(m.Colnets); size != 16 {
		err = ssz.ErrBytesLengthFn("--.Colnets", size, 16)
		return
	}
	dst = append(dst, m.Colnets...)
...
func (m *MetaDataV2) UnmarshalSSZ(buf []byte) error {
	...
	// Field (3) 'Colnets'
	if cap(m.Colnets) == 0 {
		m.Colnets = make([]byte, 0, len(buf[17:33]))
	}
	m.Colnets = append(m.Colnets, buf[17:33]...)
...
// MarshalSSZ ssz marshals the ColumnSidecarsByRangeRequest object
func (c *ColumnSidecarsByRangeRequest) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(c)
}

// MarshalSSZTo ssz marshals the ColumnSidecarsByRangeRequest object to a target array
func (c *ColumnSidecarsByRangeRequest) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(20)
	...
	// Offset (2) 'SlotCols'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(c.SlotCols); ii++ {
		offset += 4
		offset += c.SlotCols[ii].SizeSSZ()
	}

	// Field (2) 'SlotCols'
	if size := len(c.SlotCols); size > 1024 {
		err = ssz.ErrListTooBigFn("--.SlotCols", size, 1024)
		return
	}
	{
		offset = 4 * len(c.SlotCols)
		for ii := 0; ii < len(c.SlotCols); ii++ {
			dst = ssz.WriteOffset(dst, offset)
			offset += c.SlotCols[ii].SizeSSZ()
		}
	...
	for ii := 0; ii < len(c.SlotCols); ii++ {
		if dst, err = c.SlotCols[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}
...
// UnmarshalSSZ ssz unmarshals the ColumnSidecarsByRangeRequest object
func (c *ColumnSidecarsByRangeRequest) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 20 {
		return ssz.ErrSize
	...
	// Field (0) 'StartSlot'
	c.StartSlot = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))

	// Field (1) 'Count'
	c.Count = ssz.UnmarshallUint64(buf[8:16])
	...
	// Field (2) 'SlotCols'
	{
		...
		c.SlotCols = make([]*ColumnSidecarsByRangeRequest_SlotColumns, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if c.SlotCols[indx] == nil {
				c.SlotCols[indx] = new(ColumnSidecarsByRangeRequest_SlotColumns)
			}
			if err = c.SlotCols[indx].UnmarshalSSZ(buf); err != nil {
				return err
			}
			return nil
		})
...
// SizeSSZ returns the ssz encoded size in bytes for the ColumnSidecarsByRangeRequest object
func (c *ColumnSidecarsByRangeRequest) SizeSSZ() (size int) {
	size = 20

	// Field (2) 'SlotCols'
	for ii := 0; ii < len(c.SlotCols); ii++ {
		size += 4
		size += c.SlotCols[ii].SizeSSZ()
	}

	return
}

// HashTreeRoot ssz hashes the ColumnSidecarsByRangeRequest object
func (c *ColumnSidecarsByRangeRequest) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(c)
}

// HashTreeRootWith ssz hashes the ColumnSidecarsByRangeRequest object with a hasher
func (c *ColumnSidecarsByRangeRequest) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	{
		subIndx := hh.Index()
		num := uint64(len(c.SlotCols))
		if num > 1024 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for _, elem := range c.SlotCols {
			if err = elem.HashTreeRootWith(hh); err != nil {
				return
			}
		}
...
// MarshalSSZ ssz marshals the ColumnSidecarsByRangeRequest_SlotColumns object
func (c *ColumnSidecarsByRangeRequest_SlotColumns) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(c)
}

// MarshalSSZTo ssz marshals the ColumnSidecarsByRangeRequest_SlotColumns object to a target array
func (c *ColumnSidecarsByRangeRequest_SlotColumns) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(4)
	...
	// Field (0) 'Columns'
	if size := len(c.Columns); size > 32 {
		err = ssz.ErrListTooBigFn("--.Columns", size, 32)
		return
	}
	for ii := 0; ii < len(c.Columns); ii++ {
		dst = ssz.MarshalUint64(dst, c.Columns[ii])
	}

	return
}

// UnmarshalSSZ ssz unmarshals the ColumnSidecarsByRangeRequest_SlotColumns object
func (c *ColumnSidecarsByRangeRequest_SlotColumns) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 4 {
		return ssz.ErrSize
	...
	// Field (0) 'Columns'
	{
		...
		c.Columns = ssz.ExtendUint64(c.Columns, num)
		for ii := 0; ii < num; ii++ {
			c.Columns[ii] = ssz.UnmarshallUint64(buf[ii*8 : (ii+1)*8])
		}
	}
	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the ColumnSidecarsByRangeRequest_SlotColumns object
func (c *ColumnSidecarsByRangeRequest_SlotColumns) SizeSSZ() (size int) {
	size = 4
...
// HashTreeRoot ssz hashes the ColumnSidecarsByRangeRequest_SlotColumns object
func (c *ColumnSidecarsByRangeRequest_SlotColumns) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(c)
}

// HashTreeRootWith ssz hashes the ColumnSidecarsByRangeRequest_SlotColumns object with a hasher
func (c *ColumnSidecarsByRangeRequest_SlotColumns) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
