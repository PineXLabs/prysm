...
// Hash: e764267976a3740a87c3487b067b430e8f07534d4a182b84727a6e4f6f5be4d9
package eth
...
func (m *MetaDataV2) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'Colnets'
	if size := len(m.Colnets); size != 8 {
		err = ssz.ErrBytesLengthFn("--.Colnets", size, 8)
		return
	}
...
func (m *MetaDataV2) UnmarshalSSZ(buf []byte) error {
	...
	// Field (3) 'Colnets'
	if cap(m.Colnets) == 0 {
		m.Colnets = make([]byte, 0, len(buf[17:25]))
	}
	m.Colnets = append(m.Colnets, buf[17:25]...)
