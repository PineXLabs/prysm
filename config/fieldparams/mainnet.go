...
const (
	...
	MaxBlobsPerBlock                      = 512           // MaxBlobsPerBlock defines the maximum number of blobs with respect to consensus rule can be included in a block.
	...
	MaxColumnsPerBlock                    = 128           // MaxColumnsPerBlock defines the maximum number of columns with respect to consensus rule can be included in a block.
)
